...
| Field | Type | Required | Description |
|---|---|---|---|
| `q` | `string` | Yes | Question text. Supports `$LaTeX$` (inline) and `$$LaTeX$$` (display) |
...
| Field | Type | Required | Description |
|---|---|---|---|
| `front` | `string` | Yes | Card front (question/term). Supports HTML |
| `back` | `string` | Yes | Card back (answer/definition). Supports HTML |
...
- Keep options parallel in grammar and length. The correct answer should not stand out as longer or more detailed
