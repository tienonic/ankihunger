      ...
      <Show when={s.state() === 'done'}>
        <div class="done-screen">
          ...
          <Show when={s.score().attempted > 0}>
            <div class="done-stats"><span class="done-stat">{s.score().correct} / {s.score().attempted} correct</span><span class="done-stat">{Math.round((s.score().correct / s.score().attempted) * 100)}% retention</span></div>
          </Show>
